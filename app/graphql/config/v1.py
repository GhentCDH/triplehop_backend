...
class GraphQLConfigBuilder:
    ...
    def _layout_field_converter(
        ...
        for panel in result:
            for field in panel['fields']:
                field['field'] = GraphQLConfigBuilder._replace_field_ids_by_system_names(
                    field['field'],
                    entity_field_lookup,
                    relation_lookup,
                ...
                if 'base_layer' in field:
                    field['base_layer'] = GraphQLConfigBuilder._replace_field_ids_by_system_names(
                        field['base_layer'],
                        entity_field_lookup,
                        relation_lookup,
                        relation_field_lookup,
    ...
    def _get_entity_configs_resolver_wrapper(self):
        async def resolver(*_):
            ...
            relation_types_config = await self._config_manager.get_relation_types_config(self._project_name)
    ...
    def _add_get_relation_configs_schema_parts(self):
        self._type_defs_dict['Query'].append(['getRelation_config_s', '[Relation_config]'])
        self._type_defs_dict.update({
            'Relation_config': [
                ['system_name', 'String!'],
                ['display_name', 'String!'],
